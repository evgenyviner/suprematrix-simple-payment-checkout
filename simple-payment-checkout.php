 ...
 * Version: 1.0.0
 * Author: Evgeny Viner
 * Text Domain: simple-payment-checkout
 * License: GPL-2.0+
...
/*
Simple Payment Checkout is free software: you can redistribute it and/or modify
it under the terms of the GNU General Public License as published by
the Free Software Foundation, either version 2 of the License, or
any later version.

Simple Payment Checkout is distributed in the hope that it will be useful,
...
function spc_add_action_links($links) {
    $settings_link = '<a href="' . admin_url('options-general.php?page=spc-settings') . '">' . __('Settings', 'simple-payment-checkout') . '</a>';
    $support_link = '<a href="https://buymeacoffee.com/evgenyviner" target="_blank" rel="noopener noreferrer">' . __('Buy me a coffee', 'simple-payment-checkout') . '</a>';
...
function spc_add_plugin_row_meta($links, $file) {
    ...
    $support_link = '<a href="https://linktr.ee/evgenyviner" target="_blank" rel="noopener noreferrer">' . __('About the Developer', 'simple-payment-checkout') . '</a>';
    $links[] = $support_link;
